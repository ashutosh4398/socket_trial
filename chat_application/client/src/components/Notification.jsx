            ...
            <div className="notifications-icon" onClick={()=>setIsOpen(!isOpen)}>
                ...
                </svg>
                {
                    unreadNotifications?.length === 0? null: (
                        <span className="notificaton-count">
            ...
            </div>
            {
                isOpen && (
                    <div className="notifications-box">
                        ...
                        {
                            modifiedNotifications?.length === 0 ? <span className="notification">No new notifications</span>: null
                        }
                        {
                            modifiedNotifications && modifiedNotifications.map((n,idx) => {
                                return <div key={idx} className={n.isRead ? 'notification': 'notification not-read'} onClick={e => {markNotificationAsRead(n, userChats, user, notifications); setIsOpen(!isOpen)}}>
